            ...
            <div class="col-sm-6">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>Laborat�rio Sistemas Operacionais e Distribuidos (LSO)</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-6">
        ...
        <div class="content mt-3">
            ...
            <div class="row lso-computer">
                    ...
                    <div class="col-sm-1 offset-1">
                       <a href="abrirchamado.jsp?id=27"><i class="pc-icon fa fa-laptop"></i></a>
                       <i class="status-icon working fa fa-check-circle"></i>
                       <div class="id-icon">27</div>  
                   </div>
                   <div class="col-sm-1">
                           <a href="abrirchamado.jsp?id=26"><i class="pc-icon fa fa-laptop"></i></a>
                       <i class="status-icon working fa fa-check-circle"></i>
                       <div class="id-icon">26</div>  
                   </div>
                   <div class="col-sm-1">
                       <a href="abrirchamado.jsp?id=25"><i class="pc-icon fa fa-laptop"></i></a>
                       <i class="status-icon working fa fa-check-circle"></i>
               ...
               <div class="row lso-computer">
                    <!-- Esquerda -->
                    <div class="col-sm-1 offset-1">
                       <a href="abrirchamado.jsp?id=24"><i class="pc-icon fa fa-laptop"></i></a>
                       <i class="status-icon working fa fa-check-circle"></i>
                       <div class="id-icon">24</div>  
                   </div>
                   <div class="col-sm-1">
                       <a href="abrirchamado.jsp?id=23"><i class="pc-icon fa fa-laptop"></i></a>
                       <i class="status-icon working fa fa-check-circle"></i> 
                       <div class="id-icon">23</div> 
                   </div>
                   <div class="col-sm-1">
                       <a href="abrirchamado.jsp?id=21"><i class="pc-icon fa fa-laptop"></i></a>
                       <i class="status-icon working fa fa-check-circle"></i>
               ...
               <div class="row lso-computer">
                   ...
                   <div class="col-sm-1">
                      <a href="abrirchamado.jsp?id=20"><i class="pc-icon fa fa-laptop"></i></a>
                       <i class="status-icon working fa fa-check-circle"></i>
                       <div class="id-icon">20</div> 
                   </div>
                   <div class="col-sm-1">
                      <a href="abrirchamado.jsp?id=19"><i class="pc-icon fa fa-laptop"></i></a>
                       <i class="status-icon working fa fa-check-circle"></i>
               ...
               <div class="row lso-computer">
                   <!-- Esquerda -->
                   <div class="col-sm-1 offset-1">
                      <a href="abrirchamado.jsp?id=18"><i class="pc-icon fa fa-laptop"></i></a>
                       <i class="status-icon working fa fa-check-circle"></i>
                       <div class="id-icon">18</div> 
                   </div>
                   <div class="col-sm-1">
                       <a href="abrirchamado.jsp?id=17"><i class="pc-icon fa fa-laptop"></i></a> 
                       <i class="status-icon working fa fa-check-circle"></i>
                       <div class="id-icon">17</div> 
                   </div>
                   <div class="col-sm-1">
                       <a href="abrirchamado.jsp?id=16"><i class="pc-icon fa fa-laptop"></i></a> 
                       <i class="status-icon working fa fa-check-circle"></i>
                ...
                <div class="row lso-computer">
                   <!-- Esquerda -->
                   <div class="col-sm-1 offset-1">
                       <a href="abrirchamado.jsp?id=15"><i class="pc-icon fa fa-laptop"></i></a>
                       <i class="status-icon working fa fa-check-circle"></i>
                       <div class="id-icon">15</div> 
                   </div>
                   <div class="col-sm-1">
                       <a href="abrirchamado.jsp?id=14"><i class="pc-icon fa fa-laptop"></i></a>
                       <i class="status-icon working fa fa-check-circle"></i>
                       <div class="id-icon">14</div> 
                   </div>
                   <div class="col-sm-1">
                       <a href="abrirchamado.jsp?id=13"><i class="pc-icon fa fa-laptop"></i></a> 
                       <i class="status-icon working fa fa-check-circle"></i>
