                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="menu-icon fa fa-sign-in"></i><a href="index.jsp">Login</a></li>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body card-block">
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">DescriÁ„o</label></div>
                                    ...
                                    <script>
                                        function loadDoc() {
                                            ...
                                            xhttp.onreadystatechange = function () {
                                                ...
                                                descricao = document.getElementById("descricao").value.toString();
                                            };
